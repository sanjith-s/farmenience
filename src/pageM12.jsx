      ...
      <div className="pay-details">
        <Element className="page1" id="page1">
          <div className="pay-nav">
            <div className="cart">
              <div>
                <a className="cart-ele1 back-btn">
            ...
            <div className="del-address">
              ...
              <div className="add2">
                ...
                <div className=" ans ans2">
                  ...
                  {!isEditOn ? (
                    <button className="chg-btn" onClick={GiveEdit}>
                      Change
                    </button>
                  ) : (
          ...
          <div className="mid-row">
            <div className="m-items m1">
              <a href="" style={{ textDecoration: "none" }}>
                <h1 className="mid-head">
                  <span className="m-text m-btn">Add More items</span>
                </h1>
              </a>
            </div>
            <div className="m-items">
              <a href="">
                <ShareIcon fontSize="large" className="m-btn" />
              </a>
            </div>
            <div className="m-items">
              <a href="">
                <DeleteIcon fontSize="large" className="m-btn" />
              </a>
            </div>
            <div className="m-items">
              <a href="">
                <ArrowForwardIosIcon fontSize="large" className="m-btn" />
              </a>
            </div>
          </div>
          ...
          <br />
          <h1 className="bot-head">Price Details</h1>
          <br />
                ...
                {itemsAdded.map((item, index) => {
                  return (
                    <tr>
                      ...
                      <td>₹ {item.discount}</td>
                      <td>₹ 50</td>
                      <td>₹ {item.price + 50 - item.discount}</td>
                    </tr>
                  );
                })}
                <tr className="bold">
        ...
        <Element className="order-summary" id="order-summary">
          <div className="orderSummary">
            ...
            <p className="ex-text bot-head">
              Choose Your Preffered Date for the Delivery
            </p>
            <br />
            ...
            <div className="time-slot" style={{ textAlign: "center" }}>
              <div style={{ textAlign: "left", display: "inline-block" }}>
                ...
                <input type="radio" name="time-opt" />
                <span>10.00 AM - 1.30 PM</span>
                <br />
                <input type="radio" name="time-opt" />
                <span>1.30 PM - 7.00 PM</span>
              </div>
            </div>
          </div>
        </Element>
