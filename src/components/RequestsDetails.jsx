      ...
      <div className="container-2">
        <div className="part-1">
          <div className="container-1">
            ...
            <div className="f-items">
              <button className="req-btn req-btn3">cancel</button>
            </div>
          </div>
          <div className="flex-item">
            <span className="label">Meet Date</span>
            <input type="date" className="values" value={props.meetDate} />
          </div>
          <div className="flex-item">
            <span className="label">Meet Time</span>
            <input type="time" className="values" value={props.meetTime} />
          </div>
          <div className="flex-item">
            <span className="label">Soil Details </span>
            <span className="values">{props.soilDetails}</span>
          </div>
          <div className="flex-item">
            <span className="label">Crops Growing </span>
            <span className="values">{props.cropsGrowing}</span>
          </div>
          <div className="flex-item">
            ...
            {updateReason ? (
              ...
              <span className="values">
                {props.meetReason}{" "}
                <a className="edit-btn" onClick={GiveEdit}>
