      ...
      <main className="about-section ">
        <section  >
          <div>
            ...
            <p className="tandc-description indent">By accessing this website we assume you accept these terms and conditions. Do not continue to use Farmenience if you do not agree to take all of the terms and conditions stated on this page.</p>

            <p className="tandc-description indent">
            ...
            <p className="tandc-description indent">We employ the use of cookies. By accessing Farmenience, you agreed to use cookies in agreement with the Company Name's Privacy Policy.</p>
            ...
            <p className="tandc-description indent" style={{ marginBottom: "0.1875rem" }}>
              Republish material from Farmenience</p>
            <p className="tandc-description indent" style={{ marginBottom: "0.1875rem" }}>
              Sell, rent or sub-license material from Farmenience
            </p>
            <p className="tandc-description indent" style={{ marginBottom: "0.1875rem" }}>
              Reproduce, duplicate or copy material from Farmenience <br />
            </p>
            <p className="tandc-description indent" style={{ marginBottom: "0.1875rem" }}>
              Redistribute content from Farmenience <br />
            </p>
            <p className="tandc-description indent" style={{ marginBottom: "0.5625rem" }}>
            ...
            <ul className="tandc-description">
              <li className="indent">You are entitled to post the Comments on our website and have all necessary licenses and consents to do so;</li>
              <li className="indent">The Comments do not invade any intellectual property right, including without limitation copyright, patent or trademark of any third party;</li>
              <li className="indent">The Comments do not contain any defamatory, libelous, offensive, indecent or otherwise unlawful material which is an invasion of privacy</li>
              <li className="indent">The Comments will not be used to solicit or promote business or custom or present commercial activities or unlawful activity.</li>
            ...
            <p className="tandc-description" style={{ fontWeight: "500" }}>
            ...
            <p className="tandc-description" >
              <ul style={{ listStyleType: "square", marginLeft: "2%" }}>
                ...
                <li>These organizations may link to our home page, to publications or to other Website information so long as the link : </li>
              </ul>

              <p className="points">(a) is not in any way deceptive;<br /></p>
              <p className="points">(b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products and/or services; and <br /></p>
              <p className="points">(c) fits within the context of the linking party's site.</p>
            </p>
            ...
            <p className="tandc-description">
              ...
              <p className="points">(a) the link would not make us look unfavorably to ourselves or to our accredited businesses;<br /></p>
              <p className="points">(b) the organization does not have any negative records with us; <br /></p>
              <p className="points">(c) the benefit to us from the visibility of the hyperlink compensates the absence of Company Name; and <br /></p>
              <p className="points">(d) the link is in the context of general resource information.</p>

              These organizations may link to our home page so long as the link : <br />
              <p className="points">(a) is not in any way deceptive; <br /></p>
              <p className="points">(b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products or services; and <br /></p>
              <p className="points">(c) fits within the context of the linking party's site.</p></p>
            ...
            <p className="tandc-description">
              ...
              <p className="tandc-points">(a) are subject to the preceding paragraph; and </p>
              <p className="tandc-points">(b) govern all liabilities arising under the disclaimer, including liabilities arising in contract, in tort and for breach of statutory duty.</p></p>
