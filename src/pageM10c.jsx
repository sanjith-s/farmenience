      ...
      <Card id="card-person">
        <div id="top-person">
          <div id="text-name-add">
            <Typography>RAJA SINGH</Typography>
            <Typography>KOYEMBEDU,CHENNAI</Typography>
          </div>
          <div>
            <CgProfile size={40} />
          </div>
        </div>
        <Typography id="text-profile">Profile</Typography>
        <Typography id="text-profile">{data}</Typography>
      </Card>
    </>
  );
};
