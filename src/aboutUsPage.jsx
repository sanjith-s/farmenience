        ...
        {/* <section> */}
          <div>
            ...
            <div className="gx-d-flex justify-content-center" style={{ position: "relative" }}>
              <h1 className="heading-primary" style={{ textAlign: "center", color: "#000", fontWeight: "37.5rem", marginBottom: "5rem", fontFamily:"arial",marginTop:"2%" }}>
                About Farmenience
              </h1>
              {/* <img src={farmsvg} alt="" style={{ height: "140px", objectFit: "cover", position: "absolute", left: "42%", top: "30px" }} /> */}
            </div>

            <p className="about-description indent" style={{margin:"80px"}}>
            ...
            <p className="about-description" style={{margin:"80px"}}>
              This website is mainly divided into 2 sections.

            </p>

            <p className="about-description points" style={{marginLeft:"170px"}} >
